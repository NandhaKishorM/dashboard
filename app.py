...
def get_bot_response():
    ...
    url = "https://projects.creativelab.deepflow.in/interact?user={}&msg={}".format(userid, userText)
...
admin.add_view(CustomView(name="DeepConvAI", endpoint='custom', menu_icon_type='fa', menu_icon_value='fa-connectdevelop',))
...
def build_sample_db():
    ...
    with app.app_context():
        ...
        test_user = user_datastore.create_user(
            first_name='Admin',
            email='admin',
            password=encrypt_password('admin'),customer_id="agfajfg",sentiment=10,
        ...
        for i in range(len(first_names)):
            ...
            user_datastore.create_user(
                ...
                email=tmp_email,
                password=encrypt_password(tmp_pass),customer_id="agfajfg",sentiment=10,
                roles=[user_role, ]
            )
        db.session.commit()
    return
